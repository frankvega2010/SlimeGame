...
namespace Juego
{
	...
	namespace Menu_Section
	{
		...
		void DrawMenu()
		{
			...
			DrawTextEx(sideFont, "Franco Vega and Lautaro Cabrini", { buttons[0].position.x * 1.8f, screenHeight / 5.0f }, defaultFontSize / 2, 2, GREEN);
			DrawTextEx(sideFont, "Version 0.3", { buttons[0].position.x - 80, screenHeight / 5.0f }, defaultFontSize / 2, 2, GREEN);
